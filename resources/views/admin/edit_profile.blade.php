                    ...
                    <form action="{{ url('update_profile', $user->id) }}" method="post" class="needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                value="{{ old('name', $user->name) }}" required autofocus style="color: black;">
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" id="email"
                                ...
                                value="{{ old('email', $user->email) }}" required style="color: black;">
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @else
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="phone" id="phone"
                                ...
                                value="{{ old('phone', $user->phone) }}" required style="color: black;">
                            @error('phone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @else
