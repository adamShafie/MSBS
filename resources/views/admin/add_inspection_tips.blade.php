          ...
          <div class="col-lg-7 col-md-9">
            <div class="card">
              <div class="card-header">
                <h2 class="h5 mb-0">New Inspection Tip</h2>
              </div>
              <div class="card-body">
                <form action="{{url('save_inspection_tips')}}" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
                  @csrf
                  <div class="mb-3">
                  ...
                  <div class="d-grid">
                    <button type="submit" class="btn btn-primary btn-block"><b>Create Tip</b></button>
                  </div>
                </form>
              </div>
            </div>
